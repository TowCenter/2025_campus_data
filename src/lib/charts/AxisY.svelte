<script>
	 ...
	 * @property {string} [labelPosition='even'] - Whether the label sits even with its value ('even') or sits on top ('above') the tick mark
	 ...
	 * @property {number|Array<any>|Function} [ticks=4] - Tick configuration
	 ...
	 * @property {number} [charPixelWidth=7.25] - Used to calculate the widest label length
	 */
